...
object CompressorUtils {
    ...
    fun getBitrate(
        ...
        var newBitrate = 0;
        Log.d("Bitrate Before", "$bitrate");
//        if (newHeight < 270){
//            Log.d("Bitrate Column", "270")
//            newBitrate =  min(bitrate, 400 * 1024);
//        }
//        else if (newHeight < 360){
//            newBitrate =  min(bitrate, 1200 * 1024)
//            Log.d("Bitrate Column", "360")
//        }
//        else if (newHeight <= 540){
//            newBitrate =  min(bitrate, 1500 * 1024)
//            Log.d("Bitrate Column", "540")
//        }
//        else if (newHeight <= 720){
//            newBitrate =  min(bitrate, 4000 * 1024)
//            Log.d("Bitrate Column", "720")
//        }
//        else if (newHeight <= 1080){
//            newBitrate =  min(bitrate, 8000 * 1024)
//            Log.d("Bitrate Column", "1080")
//        }
//        else {
//            newBitrate =  min(bitrate, 14000 * 1024)
//            Log.d("Bitrate Column", ">>>>>1080")
//        }

        var ratio = (height * width) / (newHeight * newWidth);
        newBitrate = (bitrate / ratio).toInt()

        Log.d("Bitrate After", "$newBitrate");
        return newBitrate
    }
    ...
    fun generateWidthAndHeight(
        ...
        val ratioX = maxWidth / width
        val ratioY = maxHeight / height
        val ratio = min(ratioX, ratioY)

        newHeight = roundToSixteen(height * ratio)
        newWidth = roundToSixteen(width * ratio)
        ...
        Log.d("Width", "$width")
        Log.d("Space", "---------------------------------------------")
        Log.d("Height After", "$newHeight")
        Log.d("Width After", "$newWidth")
...
fun roundToSixteen(value: Double): Int {
    //return roundEven((floor(value / 16).toInt() * 16))
    return roundEven(((value / 16).roundToInt() * 16))
}
